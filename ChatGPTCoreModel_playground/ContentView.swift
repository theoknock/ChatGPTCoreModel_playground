...
//            .backgroundStyle(Color.white.opacity(1.0))
    ...
    private func runPsalmAbstract(_ abstract: PsalmAbstract) async {
        ...
        do {
            ...
            1. The abstract should begin with a key highlight that best represents the central message or emphasis of the Psalm, reflecting its specific content and significance. Include at least one quote or citation from the psalm. Do not number this paragraph. Support every statement you write about the psalm with a reference to the verse(s), providing at least one quote for each paragraph.
            2. Clearly describe the purpose of the Psalm, explaining its spiritual intent and how it serves or helps the believer. Avoid mentioning the writer unless referring to the Psalm’s direct impact on worship or spiritual life. Include at least one quote or citation from the psalm. Do not number this paragraph. Support every statement you write about the psalm with a reference to the verse(s), providing at least one quote for each paragraph.
            3. Identify and summarize the key themes found in the psalm, supported by references from the text itself. Include at least one quote or citation from the psalm. Do not number this paragraph. Support every statement you write about the psalm with a reference to the verse(s), providing at least one quote for each paragraph.
            4. Provide a theological summary that explains how the psalm’s message contributes to an understanding of God, faith, and spiritual matters. Include at least one quote or citation from the psalm. Do not number this paragraph. Support every statement you write about the psalm with a reference to the verse(s), providing at least one quote for each paragraph.
            5. Write a Christological summary that identifies any direct or indirect connections to Christ, the gospel, or messianic prophecies. Include at least one quote or citation from the psalm. Do not number this paragraph. Support every statement you write about the psalm with a reference to the verse(s), providing at least one quote for each paragraph.
            6. Draw direct parallels to Christian teachings, using New Testament scriptures to illustrate how the message of the psalm is fulfilled or mirrored in Christ and His teachings, and give advice on how Christians today can apply the psalm’s lessons in their own lives. Include at least one quote or citation from the psalm. Do not number this paragraph. Support every statement you write about the psalm with a reference to the verse(s), providing at least one quote for each paragraph.
...
//        
//        let startMarker = "<<PSALM \(number)>>"
//        let splitOnStart = fullText.components(separatedBy: startMarker)
//        // We expect at least two parts: before the marker, and after
//        guard splitOnStart.count > 1 else { return nil }
//        
//        let afterStart = splitOnStart[1]
//        // Look for the next Psalm marker to bound our slice
//        let nextMarker = number < 150 ? "<<PSALM \(number + 1)>>" : nil
//        let endIndex: String.Index
//        if let nm = nextMarker,
//           let range = afterStart.range(of: nm) {
//            endIndex = range.lowerBound
//        } else {
//            endIndex = afterStart.endIndex
//        }
//        
//        let rawPsalm = afterStart[..<endIndex]
//        return rawPsalm.trimmingCharacters(in: .whitespacesAndNewlines)
//    }
//    
//    private func addPsalmAndRun() {
//        Task {
...
//    
//    private func runPsalmAbstract(_ abstract: PsalmAbstract) async {
//        let path = Bundle.main.path(forResource: "Psalms", ofType: "txt")
//        let allText = (try? String(contentsOfFile: path!, encoding: .utf8)) ?? String()
//        let psalm = psalmText(from: allText, number: abstract.psalmNumber)
//        
//        let instructions: Instructions = Instructions("""
//    Your instructions:
//
//    Your overall task to to write an abstract for Psalm \(abstract.psalmNumber) per instructions provided by the user in a series of prompts.
//    
//    When prompted with a specific psalm (e.g., “Psalm 23” or “23”), you will write a one paragraph of at least 5 to 6 sentences per the description provided in the prompt (i.e., its topic). The paragraph must be at least 5 lines. Do not number the paragraph or precede the paragraph with a topic summation; support every statement you write about the psalm with a reference to a verse(s) found in the psalm, providing at least one quote the paragraph:
//
//    IMPORTANT: Cite your source for every sentence you write in every paragraph (include verse(s) or excerpt(s)).
//""")
//        
...
//        
//        
//        let prompts : [Prompt] = [Prompt("Write an abstract for Psalm \(abstract.psalmNumber) per your instructions and per the six prompts that will follow. QUOTE OR CITE THE ENTIRE PSALM FIRST!!!"),
//                                  Prompt("""
//    1. The abstract should begin with a key highlight that best represents the central message or emphasis of the Psalm, reflecting its specific content and significance. Include at least one quote or citation from the psalm. This paragraph must be at least 5 to 6 sentences.
//"""),
//                                  Prompt("""
//    2. Clearly describe the purpose of the Psalm, explaining its spiritual intent and how it serves or helps the believer. Avoid mentioning the writer unless referring to the Psalm’s direct impact on worship or spiritual life. Include at least one quote or citation from the psalm. This paragraph must be at least 5 to 6 sentences.
//"""),
//                                  Prompt("""
//    3. Identify and summarize the key themes found in the psalm, supported by references from the text itself. Include at least one quote or citation from the psalm. This paragraph must be at least 5 to 6 sentences.
//"""),
//                                  
//                                  Prompt("""
//    4. Provide a theological summary that explains how the psalm’s message contributes to an understanding of God, faith, and spiritual matters. Include at least one quote or citation from the psalm. This paragraph must be at least 5 to 6 sentences.
//"""),
//                                  
//                                  Prompt("""
//    5. Write a Christological summary that identifies any direct or indirect connections to Christ, the gospel, or messianic prophecies. Include at least one quote or citation from the psalm. This paragraph must be at least 5 to 6 sentences.
//"""),
//                                  Prompt("""
//    6. Draw direct parallels to Christian teachings, using New Testament scriptures to illustrate how the message of the psalm is fulfilled or mirrored in Christ and His teachings, and give advice on how Christians today can apply the psalm’s lessons in their own lives. Include at least one quote or citation from the psalm. This paragraph must be at least 5 to 6 sentences.
//"""),                             Prompt("""
//    DID YOU REMEMBER TO QUOTE OR CITE THE ENTIRE PSALM? IF SO, DO IT HERE. FOLLOWING IS SAMPLE OUTPUT FOR PSALM 23:
//    “The LORD is my shepherd; I shall not want. He maketh me to lie down in green pastures: He leadeth me beside the still waters. He restoreth my soul: He leadeth me in the paths of righteousness for his name's sake. Yea, though I walk through the valley of the shadow of death, I will fear no evil: for thou art with me; Thy rod and thy staff they comfort me. Thou preparest a table before me in the presence of mine enemies: Thou anointest my head with oil; my cup runneth over. Surely goodness and mercy shall follow me all the days of my life: And I will dwell in the house of the LORD for ever.”
//""")]
